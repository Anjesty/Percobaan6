...
// ... (Class SoundPlayer, LocationManager, PhoneAndSmsManager tetap sama)
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize ViewModels dengan scope Activity
        ...
        // Mulai mengamati peringatan kesehatan
        observeHealthAlerts()
    }
    ...
    private fun observeHealthAlerts() {
        ...
        homeViewModel.healthAlerts.observe(this) { alerts ->
            ...
            // Update a set of recent alert messages to avoid spamming
    ...
    private fun handleSensorData(line: String) {
        ...
        if (parts.size >= 3) { // Ukuran data disesuaikan, misal format: "TYPE,BPM,SPO2"
            try {
                ...
                runOnUiThread {
                    ...
                    // Toast ini bisa dihilangkan jika notifikasi sudah muncul di halaman Notifikasi
...
//package com.example.percobaan6 NIERRRRRRRRRRRRRRRR
//
//import android.Manifest
//import android.bluetooth.*
//import android.content.Context
